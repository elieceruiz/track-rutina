...
if en_curso_actual:
    ...
    descripcion = en_curso_actual.get("subtipo") or en_curso_actual.get("motivo") or actividad
    st.warning(f"\ud83d\udd04 Tienes un **{descripcion.capitalize()}** en curso desde las {hora_ini}.")
